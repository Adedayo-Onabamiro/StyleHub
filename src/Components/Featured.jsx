...
export const Featured = () => {
  return (
    <div className='flex flex-col py-5 px-20 h-fit justify-center items-center'>
      ...
      <div className='flex flex-col md:flex-row h-4/5 w-full items-center justify-evenly'>
        <div className="grid grid-cols-12 gap-4 h-3/5 w-full">
          {/* First item with width of 60% */}
          <div className="md:col-span-7 col-span-12 h-full relative">
          ...
          <div className="md:col-span-5 col-span-12  h-full relative">
          ...
          <div className="md:col-span-5 col-span-12 col-start-1h-full relative">
          ...
          <div className="md:col-span-7 col-span-12 md:col-start-6 h-full relative">
