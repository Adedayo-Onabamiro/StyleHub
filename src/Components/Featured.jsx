      ...
      <div className='flex flex-col h-4/5 w-full items-center justify-evenly'>
        <div className="grid grid-cols-12 gap-4 h-3/5 w-full">
          ...
          <div className="col-span-7 h-full relative">
            ...
            <div className="absolute bottom-16 left-4 text-white text-3xl font-bold font-custom my-10 "> Afro Wear Collection Exclusive Series </div>
            <button className="absolute bottom-2 left-2 text-black bg-white bg-opacity-70 rounded-full px-6 py-3 my-6 flex items-center"> Shop Now <FontAwesomeIcon className=' px-1 font-custom' icon={faArrowRight} /> </button>
          </div>
          ...
          <div className="col-span-5 h-full relative">
            ...
            <div className="absolute bottom-16 left-4 text-white text-3xl font-bold font-custom my-10"> Bottega Veneta Women Exclusive Series </div>
            <button className="absolute bottom-2 left-2 text-black bg-white bg-opacity-70 rounded-full px-6 py-3 flex items-center my-6"> Shop Now <FontAwesomeIcon className=' px-1 font-custom' icon={faArrowRight} />  </button>
          </div>
          ...
          <div className="col-span-5 col-start-1h-full relative">
            ...
            <div className="absolute bottom-16 left-4 text-white text-3xl font-bold font-custom my-10"> Street Wear  Style Trend Collection </div>
            <button className="absolute bottom-2 left-2 text-black bg-white bg-opacity-70 rounded-full px-6 py-3 flex items-center my-6"> Shop Now <FontAwesomeIcon className=' px-1 font-custom' icon={faArrowRight} />  </button>
          </div>
          ...
          <div className="col-span-7 col-start-6 h-full relative">
            ...
            <div className="absolute bottom-16 left-4 text-white text-3xl font-bold font-custom my-10"> Alte’ Collection Style Trend </div>
            <button className="absolute bottom-2 left-2 text-black bg-white bg-opacity-70 rounded-full px-6 py-3 flex items-center my-6"> Shop Now <FontAwesomeIcon className=' px-1 font-custom' icon={faArrowRight} />  </button>
          </div>
        </div>
      </div>
