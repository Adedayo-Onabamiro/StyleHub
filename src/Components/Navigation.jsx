      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex md:order-2">
          <div className="flex items-center space-x-4 mx-4">
            <a href="#" className="text-black hover:text-gray-300"> <FontAwesomeIcon icon={faSearch} className="text-xl" /> </a>
            <a href="#" className="text-black hover:text-gray-300">  <FontAwesomeIcon icon={faShoppingBag} className="text-xl" />  </a>
            <a href="#" className="text-black hover:text-gray-300"> <FontAwesomeIcon icon={faHeart} className="text-xl" /> </a>
            <a href="#" className="text-black hover:text-gray-300"> <FontAwesomeIcon icon={faUser} className="text-xl" /> </a>
          </div>
        ...
        <div className={`items-center justify-between w-full md:flex md:w-auto md:order-1 ${showMenu ? '' : 'hidden'}`} id="navbar-sticky" >
          <ul className={`flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-transparent md:flex-row md:space-x-8 md:mt-0 md:border-0 ${showMenu ? '' : 'hidden'} md:flex`}>
            ...
            <li> <a href="#" className={`block py-2 pl-3 pr-4 rounded hover:underline text-black`} > Shop </a> </li>
            <li> <a href="#" className={`block py-2 pl-3 pr-4 rounded hover:underline text-black`} > Blog </a> </li>
          </ul>
        </div>
      </div>
    </nav>
